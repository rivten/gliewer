...
// TODO(hugo) : Can I get rid of this ?
// NOTE(hugo) : This is an exact copy of the code that can be found in SDL_scancode.h but reused for generic reasons
// If a change is made in another version of this file, platform.h should be modified as well
enum scancode
{
    SCANCODE_UNKNOWN = 0,
...
{
    Assert((u8)Scancode < ArrayCount(Input->KeyboardButtons));
    bool Result = (Input->KeyboardButtons[Scancode] == 1);
