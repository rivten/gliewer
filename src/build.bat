...
set CommonCompilerDebugFlags=/MT /O2 /Oi /EHa /WX /W4 %UntreatedWarnings% /Z7 /nologo /I %SDLPath%\include\ /I %GLEWPath%\include\ /I %ImGuiPath% /I %TinyObjLoaderPath% /I %STBPath% /DRIVTEN_SLOW=1
